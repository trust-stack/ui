...
<html lang="en">
  <head>
    ...
    <style>
      :root {
        --primary-pink: #de738d;
        --primary-pink-light: #e5c1c8;
        --primary-pink-bg: #faf0f2;
  ...
  <body>
    <div class="mobile">
      <header class="header">
        <h1 class="header-title">Guarantee of Origin</h1>
      </header>
      ...
      <section>
        ...
        <p class="address">2170 Adelargo Road, Warraderry NSW 2810</p>
        <div class="property-details">
          <div class="detail-item">
            <span class="detail-label">Plan Number</span>
            <span class="detail-value">1170998</span>
          </div>
        </div>
      </section>
      ...
      <section class="land-titles-logo">
        <img
          src="https://online.nswlrs.com.au/six/static/themes/six-theme/resources/img/hdr-logo.png"
        />
      </section>
    </div>
