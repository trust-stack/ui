...
<html lang="en">
  <head>
    ...
    <title>CIBO Deforestation Verification</title>
    <link
    ...
    <style>
      :root {
        ...
        --primary-green-light: #8ab586;
        --primary-green-bg: #f0f7ef;
  ...
  <body>
    <div class="mobile">
      <header class="header">
        <h1 class="header-title">Deforestation Verification</h1>
      </header>
      ...
      <section>
        <div class="verification-container">
          <div class="verification-status">
            ...
            <span>No Deforestation Detected</span>
          </div>
        </div>
      </section>

      <section class="declarations">
        <div class="declaration-title">Land Boundary Evidence</div>
        <div class="cards-conformities">
          <div class="cards-conformity">
            <div class="table">
              <div class="table-item">
                <div class="item-title">Credential</div>
                <div class="item-value">Guarantee of Origin Credential</div>
              </div>
              <div class="table-item">
                <div class="item-title">Issued By</div>
                <div class="item-value">NSW Land Registry</div>
              </div>
              <div class="table-item">
                <div class="item-title">Evidence</div>
                <div class="item-value">
                  <a href="/output/go.html" class="blue-bottom-line-thick">
                    GO Credential
                  </a>
                </div>
              </div>
      ...
      <section class="land-titles-logo">
        <img
          src="https://fs.hubspotusercontent00.net/hubfs/21136401/PNG%20Transparent%20background.png"
          alt="CIBO Logo"
        />
      </section>
    </div>
