    ...
    <CompactScreen onLayout={(e) => setWidth(e.nativeEvent.layout.width)}>
      <CompactScreen.Header>
        <TopAppBar backgroundColor={"$surfaceContainerLowest"}>
          <TopAppBar.TopRail>
            ...
            <Ticker forms={forms} animatedValue={scrollOffsetX} width={width} />
      ...
      <CompactScreen.Footer>
        <BottomAppBar
          ...
          alignContent="center"
        >
          <IconButton variant="filled" onPress={onPrev} disabled={disablePrev}>
          ...
          <View>
            ...
            >
              <Button.Spinner />
              <Button.Text>{isSubmit ? "Submit" : "Next"}</Button.Text>
              <Button.Icon Icon={isSubmit ? Upload : ChevronRight} />
            </Button>
          </View>
        </BottomAppBar>
      </CompactScreen.Footer>
