...
import {Calendar, File, Menu} from "@truststack/icons-ui";
    ...
    >
      <TopAppBar size={"small"}>
        <TopAppBar.TopRail>
          ...
          <TopAppBar.SmallHeadline>Small App Bar</TopAppBar.SmallHeadline>
      ...
      <TopAppBar size={"small"} centered>
        <TopAppBar.TopRail>
          <TopAppBar.LeadingIcon icon={Menu} />
          <TopAppBar.SmallHeadline>Small Center</TopAppBar.SmallHeadline>
      ...
      <TopAppBar size="medium">
        ...
        <TopAppBar.BottomRail>
          <TopAppBar.MediumHeadline>Medium App Bar</TopAppBar.MediumHeadline>
        </TopAppBar.BottomRail>
      </TopAppBar>
      ...
      <TopAppBar size="large">
        ...
        <TopAppBar.BottomRail>
          <TopAppBar.LargeHeadline>Large App Bar</TopAppBar.LargeHeadline>
        </TopAppBar.BottomRail>
      </TopAppBar>
    </YStack>
  );
